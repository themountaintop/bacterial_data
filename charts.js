...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var barData = [{
      ...
      //hoverlabel: size=8, - I don't know, I can't get the hover text to size down.
      type:"bar",
      marker: {
        color: 'rgb(0,0,255)',
        opacity: 0.6,
...
// https://plotly.com/javascript/colorscales/
    ...
    marker: {
      color: otuIds,
      colorscale:otuIds,
      //colorscale: "Jet", - I really wanted to use this colorscale instead but directions say otherwise.
      size: sampleValues
  }
}];
...
// 1. Create a variable that filters the metadata array for the object with the desired sample number.
    ...
    // Removed some steps that were already accomplished above.
    ...
    var gaugeData = [{
      ...
      type: "indicator",
      mode: "gauge+number",
      title:{text: "<b>Belly Button Washing Frequency</b><br>Scrubs Per Week"}, //This text was a pain, fyi.
      //"The maximum range for the gauge should be 10."
      gauge: { 
        axis: {
          range: [null, 10],
